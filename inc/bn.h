//
// Created by daniil on 01.01.2022.
//
...
void bignum_copy(struct bn* n, const struct bn* m); // n = m;
...
void bignum_bit_left_shift(struct bn* a, struct bn* n, struct bn* c);
...
//ADDITION
void convert_from_bignum_to_hash(bignum* dst, bignum* src);
